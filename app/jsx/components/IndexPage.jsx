            ...
            gender_opts: [
                {
                    ...
                    name_alt: '大專組',
                    name: 'Men',
                    season_id: 'GAettcCoyovNaTho83OiDL'
                }
            ],
            selected_gender: {
                type: 'men',
                ...
                <div>
                    <section id="schedule_m">
                        <div className="standings container">
                            <div className="row">
                                <div className="col-lg-10 col-lg-offset-1 text-center">
                                    ...
                                    <table className="table" id="standings">
                                        <thead>
                                        <tr>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-10 col-lg-offset-1 text-center" id="schedule">
